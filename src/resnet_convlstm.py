...
Implementation Adapted from: github.com/raghakot/keras-resnet  and from Keras/TensorFlow repository
Our CLRNet is made to work similar to Keras ResNet Implementation.
Therefore much of the functionality and code is similar to ResNet.
"""  # pylint: disable=E501
from __future__ import division

import six
from tensorflow.python.keras import backend as K, Model, Input
from tensorflow.python.keras.layers import BatchNormalization, Activation, Dense, Dropout, ConvLSTM2D, add, GlobalAveragePooling3D, Reshape, GlobalMaxPooling3D, \
    MaxPooling3D
